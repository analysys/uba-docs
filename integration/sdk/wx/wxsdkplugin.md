...
|                  js文件                  |          功能描述         | 是否必须 |
| :------------------------------------: | :-------------------: | :--: |
|   AnalysysAgent_WX_SDK.plugin.min.js   |         插件版SDK        |  二选一 |
| AnalysysAgent_WX_SDK.plugin.es6.min.js |      插件版ES6语法SDK      |  二选一 |
|     AnalysysAgent_encryption.min.js    |          加密模块         |  非必须 |
|   AnalysysAgent_encryption.es6.min.js  | 加密模块ES6语法配合插件版ES6版本使用 |  非必须 |
...
将 AnalysysAgent_WX_SDK.plugin.min.js或AnalysysAgent_WX_SDK.plugin.es6.min.js 文件放到小程序的目录下
...
在组件Component 内通过以下代码获取 AnalysysAgent_WX_SDK 全局函数:
