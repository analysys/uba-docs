...
|                 js文件                |          功能描述         | 是否必须 |
| :---------------------------------: | :-------------------: | :--: |
|    AnalysysAgent_Baidu_SDK.min.js   |        基础模块SDK        |  二选一 |
|  AnalysysAgent_Baidu_SDK.es6.min.js |      基础模块ES6语法SDK     |  二选一 |
...
将 AnalysysAgent_Baidu_SDK.min.js 文件放到小程序的目录下
...
在各个 Page 内通过以下代码获取 AnalysysAgent_Baidu_SDK 全局函数:

```javascript
let AnalysysAgent = swan.AnalysysAgent;
```

在组件Component 内通过以下代码获取 AnalysysAgent_Baidu_SDK 全局函数:
