...
|                       js文件                       | 功能描述     | 是否必须 |
| :----------------------------------------------: | -------- | ---- |
|        AnalysysAgent_WeCode_SDK.es6.min.js       | 基础模块SDK  | 二选一  |
|        AnalysysAgent_WeCode_SDK.amd.min.js       | 基础模块SDK  | 二选一  |
|    AnalysysAgent_WeCode_encryption.es6.min.js    | 加密模块     | 非必须  |
|    AnalysysAgent_WeCode_encryption.amd.min.js    | 加密模块     | 非必须  |
| AnalysysAgent_WeCode_PageViewStayTime.es6.min.js | 页面访问时长模块 | 非必须  |
| AnalysysAgent_WeCode_PageViewStayTime.amd.min.js | 页面访问时长模块 | 非必须  |
|   AnalysysAgent_WeCode_ExposurePoint.es6.min.js  | 曝光点采集模块  | 非必须  |
|   AnalysysAgent_WeCode_ExposurePoint.amd.min.js  | 曝光点采集模块  | 非必须  |
...
自行下载SDK。获取AnalysysAgent_WeCode_SDK.amd.min.js，假设该文件放到与 require.js 同一目录中
