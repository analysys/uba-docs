...
| :---------------------------------------: | :----------: | :------------------------------------------------------------------------------------------: | -------- |
|        AnalysysAgent_JS_SDK.min.js        |    基础模块SDK   |                                            非ES6必须                                            | 全部       |
|      AnalysysAgent_JS_SDK.es6.min.js      |    基础模块SDK   |                                             ES6必须                                            | 全部       |
|      AnalysysAgent_JS_SDK.amd.min.js      |    基础模块SDK   |                                             AMD必须                                            | 全部       |
|     AnalysysAgent_JS_SDK_VISUAL.min.js    |   可视化模块SDK   |          <p>可选</p><p><a href="plus.md#ke-shi-hua-mai-dian-jie-shao">可视化埋点介绍</a></p>          | 全部       |
|    AnalysysAgent_JS_SDK_HEATMAP.min.js    |    热图模块SDK   |              <p>可选</p><p><a href="plus.md#re-tu-mo-kuai-jie-shao">热图模块介绍</a></p>             | 4.3.0及以上 |
|        AnalysysAgent_Encrypt.min.js       |    加密模块SDK   |             <p>可选</p><p><a href="plus.md#jia-mi-mo-kuai-jie-shao">加密模块介绍</a></p>             | 全部       |
|      AnalysysAgent_Encrypt.es6.min.js     |    加密模块SDK   |             <p>可选</p><p><a href="plus.md#jia-mi-mo-kuai-jie-shao">加密模块介绍</a></p>             | 全部       |
|      AnalysysAgent_Encrypt.amd.min.js     |    加密模块SDK   |             <p>可选</p><p><a href="plus.md#jia-mi-mo-kuai-jie-shao">加密模块介绍</a></p>             | 全部       |
|          AnalysysAgent_GBK.min.js         |  GBK转码模块SDK  |       <p>可选</p><p><a href="plus.md#gbk-zhuan-ma-mo-kuai-sdk-jie-shao">GBK转码模块介绍</a></p>      | 全部       |
|        AnalysysAgent_GBK.es6.min.js       |  GBK转码模块SDK  |       <p>可选</p><p><a href="plus.md#gbk-zhuan-ma-mo-kuai-sdk-jie-shao">GBK转码模块介绍</a></p>      | 全部       |
|        AnalysysAgent_GBK.amd.min.js       |  GBK转码模块SDK  |       <p>可选</p><p><a href="plus.md#gbk-zhuan-ma-mo-kuai-sdk-jie-shao">GBK转码模块介绍</a></p>      | 全部       |
|   AnalysysAgent_PageViewStayTime.min.js   |  页面访问时长模块SDK | <p>可选</p><p><a href="plus.md#ye-mian-fang-wen-shi-chang-mo-kuai-jie-shao">页面访问时长模块介绍</a></p> | 4.4.1及以上 |
| AnalysysAgent_PageViewStayTime.es6.min.js |  页面访问时长模块SDK | <p>可选</p><p><a href="plus.md#ye-mian-fang-wen-shi-chang-mo-kuai-jie-shao">页面访问时长模块介绍</a></p> | 4.4.1及以上 |
| AnalysysAgent_PageViewStayTime.amd.min.js |  页面访问时长模块SDK | <p>可选</p><p><a href="plus.md#ye-mian-fang-wen-shi-chang-mo-kuai-jie-shao">页面访问时长模块介绍</a></p> | 4.4.1及以上 |
|     AnalysysAgent_ExposurePoint.min.js    |  曝光点采集模块SDK  |    <p>可选</p><p><a href="plus.md#bao-guang-dian-cai-ji-mo-kuai-jie-shao">曝光点采集模块介绍</a></p>    | 全部       |
|   AnalysysAgent_ExposurePoint.es6.min.js  |  曝光点采集模块SDK  |    <p>可选</p><p><a href="plus.md#bao-guang-dian-cai-ji-mo-kuai-jie-shao">曝光点采集模块介绍</a></p>    | 全部       |
|   AnalysysAgent_ExposurePoint.amd.min.js  |  曝光点采集模块SDK  |    <p>可选</p><p><a href="plus.md#bao-guang-dian-cai-ji-mo-kuai-jie-shao">曝光点采集模块介绍</a></p>    | 全部       |
|         AnalysysAgent_MPAAS.min.js        | mPaas通信模块SDK |            <p>可选</p><p><a href="plus.md#mpaas-mo-kuai-jie-shao">mPaas通信模块</a></p>            | 全部       |
|       AnalysysAgent_MPAAS.es6.min.js      | mPaas通信模块SDK |            <p>可选</p><p><a href="plus.md#mpaas-mo-kuai-jie-shao">mPaas通信模块</a></p>            | 全部       |
|       AnalysysAgent_MPAAS.amd.min.js      | mPaas通信模块SDK |            <p>可选</p><p><a href="plus.md#mpaas-mo-kuai-jie-shao">mPaas通信模块</a></p>            | 全部       |
