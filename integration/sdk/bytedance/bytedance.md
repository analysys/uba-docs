...
|                  js文件                  |   功能描述  | 是否必须 |
| :------------------------------------: | :-----: | :--: |
|   AnalysysAgent_ByteDance_SDK.min.js   | 基础模块SDK |  二选一 |
| AnalysysAgent_ByteDance_SDK.es6.min.js | 基础模块SDK |  二选一 |
|     AnalysysAgent_encryption.min.js    |   加密模块  |  非必须 |
|   AnalysysAgent_encryption.es6.min.js  |   加密模块  |  非必须 |
...
将 AnalysysAgent_ByteDance_SDK.min.js 文件放到小程序的目录下
...
在各个 Page 内通过以下代码获取 AnalysysAgent_ByteDance_SDK 全局函数:
