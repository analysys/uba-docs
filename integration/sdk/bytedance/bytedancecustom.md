...
|                      js文件                     |   功能描述  | 是否必须 |
| :-------------------------------------------: | :-----: | :--: |
|   AnalysysAgent_ByteDance_SDK.custom.min.js   | 基础模块SDK |  二选一 |
| AnalysysAgent_ByteDance_SDK.custom.es6.min.js | 基础模块SDK |  二选一 |
...
将 AnalysysAgent_ByteDance_SDK.custom.min.js 文件放到小程序的目录下
