...
|                 js文件                |          功能描述         | 是否必须 |
| :---------------------------------: | :-------------------: | :--: |
|   AnalysysAgent_Alipay_SDK.min.js   |        基础模块SDK        |  二选一 |
| AnalysysAgent_Alipay_SDK.es6.min.js |      基础模块ES6语法SDK     |  二选一 |
...
将 AnalysysAgent_Alipay_SDK.min.js 文件放到小程序的目录下
...
在各个 Page 内通过以下代码获取 AnalysysAgent_Alipay_SDK 全局函数:

```javascript
let AnalysysAgent = my.AnalysysAgent;
```

在组件Component 内通过以下代码获取 AnalysysAgent_Alipay_SDK 全局函数:
...
![](<../../../.gitbook/assets/1575888678435 (2).png>)
