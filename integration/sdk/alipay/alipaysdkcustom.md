...
|                    js文件                    |          功能描述         | 是否必须 |
| :----------------------------------------: | :-------------------: | :--: |
|   AnalysysAgent_Alipay_SDK.custom.min.js   |         框架版SDK        |  二选一 |
| AnalysysAgent_Alipay_SDK.custom.es6.min.js |      框架版ES6语法SDK      |  二选一 |
...
将 AnalysysAgent_Alipay_SDK.custom.min.js 文件放到小程序的目录下
