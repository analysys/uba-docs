...
|                     js文件                     |          功能描述         | 是否必须 |
| :------------------------------------------: | :-------------------: | :--: |
|   AnalysysAgent_Dingtalk_SDK.custom.min.js   |        基础模块SDK        |  二选一 |
| AnalysysAgent_Dingtalk_SDK.custom.es6.min.js |      基础模块ES6语法SDK     |  二选一 |
...
将 AnalysysAgent_Dingtalk.custom.min.js 文件放到小程序的目录下
